...
class _VideoService implements VideoService {
  ...
  Future<List<Video>> getAllVideos() async {
    ...
    final _options = _setStreamType<List<Video>>(
  ...
  Future<Video> getOneVideo(int id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<Video>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'video/${id}',
  ...
  @override
  Future<Comment> addComment(int videoId, String comment) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
